    ...
    <div id="usces-page">
      <section id="usces-page-in">
        <?php if (have_posts()) : usces_remove_filter(); ?>
          <h1 class="title"><span><?php _e('Membership', 'usces'); ?></span></h1>
			...
			<?php endif; ?>
                    ...
                    <h3><span><?php _e('Purchase history', 'usces'); ?></span></h3>
                      <div class="currency_code"><?php _e('Currency','usces'); ?> : <?php usces_crcode(); ?></div>
                        <?php usces_member_history(); ?>
	
                    <h3 id="edit"><span><?php _e('Member information editing', 'usces'); ?></span></h3>
