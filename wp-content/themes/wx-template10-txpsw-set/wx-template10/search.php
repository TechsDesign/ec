            ...
            <div class="content-in">
              <div class="content-box">
                <?php
                  ...
                  $tx_post_thumbnail = get_the_post_thumbnail($post->ID, array(250,200), array('class' => 'tx_thumnail'));
                  $tx_post_data = get_the_time('Y&#047;m&#047;d', $post->ID);
                    echo '<div class="content-left"><div class="content-hover"><a href="'.get_permalink().'"><span>&nbsp;</span></a></div>';
                ...
                ?>
                          ...
                          <div class="content-right">
                            <div class="content-right-in">
                              <div class="tag-nav">
                                <?php $tx_posttags = get_the_tag_list('<p><span>&nbsp;</span>', '</p><p><span>&nbsp;</span>', '</p>'); if($tx_posttags){ echo '<div class="posttags">'.$tx_posttags.'</div>'; } ?>
