...
if($order_action == 'new'){
	...
	$include_tax_standard = '';
	$include_tax_reduced = '';
	$tax_target = $condition['tax_target'];
...
?>
	...
	orderfunc = {
		...
		<?php if( $reduced_taxrate ): ?>
			...
			$( "#subtotal_standard" ).html( addComma( subtotal_standard + order_shipping_charge + order_cod_fee + '' ) );
		...
		<?php if( $reduced_taxrate ): ?>
			...
			var order_cod_fee = parseFloat( $( '#order_cod_fee' ).val() );
			//var order_discount = parseFloat( $( '#order_discount' ).val() );
			var order_discount_standard = parseFloat( $( '#order_discount_standard' ).val() );
			var order_discount_reduced = parseFloat( $( '#order_discount_reduced' ).val() );
			...
			s.data = {
				...
				discount_standard: order_discount_standard,
				discount_reduced: order_discount_reduced,
